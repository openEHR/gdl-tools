...
public class ClinicalModelsAdministrationConfiguration {

    @Bean
    CMAdministrationFacadeDelegate cmAdministrationFacadeDelegate(CMElementDAOFactory cmElementDAOFactory) {
        return new PlainCMAdministrationFacadeDelegate(cmElementDAOFactory);
    }
}
