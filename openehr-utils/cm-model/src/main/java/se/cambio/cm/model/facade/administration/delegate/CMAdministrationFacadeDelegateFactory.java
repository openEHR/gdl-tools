...
public class CMAdministrationFacadeDelegateFactory {
    private static String DELEGATE_CLASS_ADMIN = "CMAdminFacadeDelegate/Class";

    private CMAdministrationFacadeDelegateFactory() {
    }
    ...
    public static CMAdministrationFacadeDelegate getDelegate()
            throws InternalErrorException {
        try {
            return (CMAdministrationFacadeDelegate)getDelegateClass().newInstance();
        } catch (Exception e) {
            throw new InternalErrorException(e);
        }
    }
