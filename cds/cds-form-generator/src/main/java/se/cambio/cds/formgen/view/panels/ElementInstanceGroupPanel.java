...
import se.cambio.cds.openehr.view.applicationobjects.ArchetypeReferences;
...
public class ElementInstanceGroupPanel extends JPanel {
	...
	JButton button = new JButton(ImageUtil.ADD_ICON);
