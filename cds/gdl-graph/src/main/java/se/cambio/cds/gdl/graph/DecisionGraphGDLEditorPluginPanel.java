...
public class DecisionGraphGDLEditorPluginPanel extends AbstractPluginPanel {
    ...
    private JComponent graphComponent;

    public DecisionGraphGDLEditorPluginPanel(){
        init();
    }
    ...
    public ImageIcon getPluginIcon() {
        URL url = DecisionGraphGDLEditorPluginPanel.class.getResource("/img/graph.png");
        if (url != null)  {
