...
image::img/samples/28_selecting_birthdate.value.jpg[title="Selecting Birthdate.value", align="center"]
...
A version of the final GDL file can be found at Appendix B.