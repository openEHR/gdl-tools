...
public class InitialLoadingObservable extends Observable{
	...
	ARCHETYPES, TEMPLATES, TERMINOLOGIES, ONTOLOGIES
    }
	...
	double numToLoad = LoadingStage.values().length;
	return ((double)getDelegate()._numLoaded/numToLoad) + getCurrentStageProgress()/numToLoad;
    }
