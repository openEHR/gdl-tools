...
public class DVProportionPanel extends DVGenericPanel{
	...
	if (dataValue instanceof DvProportion){
	    ...
	    numerator = DVUIUtil.roundToStr(dvProportion.getNumerator(), dvProportion.getPrecision());
	    denominator = DVUIUtil.roundToStr(dvProportion.getDenominator(), dvProportion.getPrecision());
