...
public class OpenEHRDataValuesUI {
	...
	_openEHRDVIcons.put(OpenEHRDataValues.DV_TEXT, ImageUtil.DV_TEXT_ICON);
	...
	_openEHRDVIconName.put(OpenEHRDataValues.DV_TEXT, ImageUtil.DV_TEXT_NAME);
	...
	_openEHRDVIcons.put(OpenEHRDataValues.DV_CODED_TEXT, ImageUtil.DV_CODED_TEXT_ICON);
	...
	_openEHRDVIconName.put(OpenEHRDataValues.DV_CODED_TEXT, ImageUtil.DV_CODED_TEXT_NAME);
	...
	_openEHRDVIcons.put(OpenEHRDataValues.DV_ORDINAL, ImageUtil.DV_ORDINAL_ICON);
	...
	_openEHRDVIconName.put(OpenEHRDataValues.DV_ORDINAL, ImageUtil.DV_ORDINAL_NAME);
	...
	_openEHRDVIcons.put(OpenEHRDataValues.DV_QUANTITY, ImageUtil.DV_QUANTITY_ICON);
	...
	_openEHRDVIconName.put(OpenEHRDataValues.DV_QUANTITY, ImageUtil.DV_QUANTITY_NAME);
	...
	_openEHRDVIcons.put(OpenEHRDataValues.DV_COUNT, ImageUtil.DV_COUNT_ICON);
	...
	_openEHRDVIconName.put(OpenEHRDataValues.DV_COUNT, ImageUtil.DV_COUNT_NAME);
	...
	_openEHRDVIcons.put(OpenEHRDataValues.DV_DURATION, ImageUtil.DV_DURATION_ICON);
	...
	_openEHRDVIconName.put(OpenEHRDataValues.DV_DURATION, ImageUtil.DV_DURATION_NAME);
	...
	_openEHRDVIcons.put(OpenEHRDataValues.DV_DATE_TIME, ImageUtil.DV_DATE_TIME_ICON);
	...
	_openEHRDVIconName.put(OpenEHRDataValues.DV_DATE_TIME, ImageUtil.DV_DATE_TIME_NAME);
	...
	_openEHRDVIcons.put(OpenEHRDataValues.DV_DATE, ImageUtil.DV_DATE_TIME_ICON);
	...
	_openEHRDVIconName.put(OpenEHRDataValues.DV_DATE, ImageUtil.DV_DATE_TIME_NAME);
	...
	_openEHRDVIcons.put(OpenEHRDataValues.DV_TIME, ImageUtil.DV_DATE_TIME_ICON);
	...
	_openEHRDVIconName.put(OpenEHRDataValues.DV_TIME, ImageUtil.DV_DATE_TIME_NAME);
	...
	_openEHRDVIcons.put(OpenEHRDataValues.DV_BOOLEAN, ImageUtil.DV_BOOLEAN_ICON);
	...
	_openEHRDVIconName.put(OpenEHRDataValues.DV_BOOLEAN, ImageUtil.DV_BOOLEAN_NAME);
	...
	_openEHRDVIcons.put(OpenEHRDataValues.DV_PROPORTION, ImageUtil.DV_PROPORTION_ICON);
	...
	_openEHRDVIconName.put(OpenEHRDataValues.DV_PROPORTION, ImageUtil.DV_PROPORTION_NAME);
    }
	...
	if (getDelegate()._defaultLanguageCodePhrase==null){
	    getDelegate()._defaultLanguageCodePhrase = new CodePhrase(
		    "ISO_639-1", 
		    UserConfigurationManager.DEFAULT_LANGUAGE);
	}
