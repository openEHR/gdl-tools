...
public class TemplateObjectBundleCustomVO implements Serializable {

    private static final long serialVersionUID = 25042012L;
    private TemplateDTO templateVO = null;
    ...
    public TemplateObjectBundleCustomVO(
    ...
    public TemplateDTO getTemplateVO() {
        return templateVO;
    }
    public void setTemplateVO(TemplateDTO templateVO) {
        this.templateVO = templateVO;
    }
    ...
    public void setProportionTypes(Collection<ProportionTypeVO> proportionTypeVOs) {
        this.proportionTypeVOs = proportionTypeVOs;
    }
}
/*
