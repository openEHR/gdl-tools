...
import se.cambio.cds.openehr.view.panels.DVBooleanPanel;
import se.cambio.cds.openehr.view.panels.DVCodedTextPanel;
import se.cambio.cds.openehr.view.panels.DVCountPanel;
import se.cambio.cds.openehr.view.panels.DVDatePanel;
import se.cambio.cds.openehr.view.panels.DVDateTimePanel;
import se.cambio.cds.openehr.view.panels.DVDurationPanel;
import se.cambio.cds.openehr.view.panels.DVGenericPanel;
import se.cambio.cds.openehr.view.panels.DVOrdinalPanel;
import se.cambio.cds.openehr.view.panels.DVProportionPanel;
import se.cambio.cds.openehr.view.panels.DVQuantityPanel;
import se.cambio.cds.openehr.view.panels.DVTextPanel;
import se.cambio.cds.openehr.view.panels.DVTimePanel;
