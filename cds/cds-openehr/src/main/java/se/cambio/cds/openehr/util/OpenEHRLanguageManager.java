...
public final class OpenEHRLanguageManager {
	...
	try {
	    String msgBundle = ConfigurationParametersManager.getParameter(MESSAGES_BUNDLE);
	    _resource = ResourceBundle.getBundle(msgBundle,new Locale(_lng,country));
	} catch (MissingConfigurationParameterException e) {
	    ExceptionHandler.handle(e);
	}
    }
    public static String getLanguage(){
	return getDelegate()._lng;
    }
