...
public class DomainsUI {
    ...
    public static ImageIcon EHR_ICON = ImageUtil.EHR_LABEL_ICON;
    public static ImageIcon CDS_ICON = ImageUtil.CDS_LABEL_ICON;
    public static ImageIcon ANY_ICON = ImageUtil.ANY_LABEL_ICON;
