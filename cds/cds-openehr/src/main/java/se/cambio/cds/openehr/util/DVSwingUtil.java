...
import se.cambio.cds.openehr.view.util.DVPanelFactory;
import se.cambio.cds.openehr.view.util.MultipleIcon;
...
public class DVSwingUtil {
	...
	return new ElementInstance(
		...
		null, GuideUtil.NULL_FLAVOUR_VALUE);
    }
	...
	label.setToolTipText(ArchetypeElements.getHTMLTooltip(archetypeElementVO, null));
	...
	label.setToolTipText(
		ArchetypeElements.getHTMLTooltip(
			archetypeElement,
	...
	public void focusLost(FocusEvent ev) {
	    ...
	    elementInstance.setNullFlavour(dataValue!=null?null:GuideUtil.NULL_FLAVOUR_VALUE);
	}
    }
