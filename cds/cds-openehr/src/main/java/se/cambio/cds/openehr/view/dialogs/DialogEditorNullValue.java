...
public class DialogEditorNullValue  extends JDialog {
	...
	return OpenEHRConst.NULL_FLAVOUR_MAP.get(getComboBox().getSelectedItem());
    }
	...
	if (comboBox==null){
	    ...
	    for (String nullFlavourCode : OpenEHRConst.NULL_FLAVOUR_MAP.keySet()) {
	...
	public Component getListCellRendererComponent(JList list, Object value,
	    ...
	    if (OpenEHRConst.NULL_FLAVOUR_MAP.containsKey(value)){
		String desc = OpenEHRConst.NULL_FLAVOUR_MAP.get(value).getValue();
		setText(desc);
		setToolTipText(desc);
	    }else{
		setText(" ");
