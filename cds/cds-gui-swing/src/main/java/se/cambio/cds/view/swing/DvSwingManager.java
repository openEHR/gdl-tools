...
public class DvSwingManager {
    ...
    public static void disable(JComponent component) {
        if (component instanceof JTextField) {
            ...
            disable(dateChooser.getDateEditor().getUiComponent());
            dateChooser.getCalendarButton().setVisible(false);
        } else {
            LoggerFactory.getLogger(DvSwingManager.class).warn("Element '" + component.getClass().getName() + "' has not been disabled");
        }
    }
    ...
    public static void enable(JComponent component) {
        if (component instanceof JTextField) {
            ...
            JDateChooser dateChooser = (JDateChooser) component;
            enable(dateChooser.getDateEditor().getUiComponent());
