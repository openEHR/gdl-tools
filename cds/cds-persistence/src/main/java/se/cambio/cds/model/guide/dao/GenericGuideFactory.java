 ...
 * @author iago.corbal
 */
public class GenericGuideFactory {

    private static String DAO_CLASS_GUIDE = "GenericGuideDAO/Class";

    private GenericGuideFactory() {
    }
    ...
    public static GenericGuideDAO getDAO() 
	    throws InternalErrorException {
	try {
	    return (GenericGuideDAO)getDAOClass().newInstance();
	} catch (Exception e) {
	    throw new InternalErrorException(e);
	} 
    }
